...
tic;
%phase modulation%
matFileName = sprintf('00%dqutrit intensity projection beam8',p);
phi2=fliplr(readmatrix(fullfile('\\Yqog_nas\yqog\01 개인폴더 (shared)\류민석\SLM\qutrit intensity projection beam8',matFileName)));
dim2=size(phi2);
mx4=dim2(1);
my4=dim2(2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
