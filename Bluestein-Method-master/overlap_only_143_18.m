...
tic;
writematrix(overlap1,fullfile('//Yqog_nas/yqog/12 Experimental data/SLM/Simulation/Intensity masking','overlap_18mm_1.csv'));
writematrix(overlap2,fullfile('//Yqog_nas/yqog/12 Experimental data/SLM/Simulation/Intensity masking','overlap_18mm_2.csv'));
toc
end