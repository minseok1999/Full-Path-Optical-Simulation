...
%%%%power meter, not normalized

gdot=sign(1-sign(x9.^2+y9.^2-(2.5).^2));
powermeter(q,p)=(sum(abs(g9.*gdot),'all')^2);
...
writematrix(powermeter,fullfile('//Yqog_nas/yqog/12 Experimental data/SLM/Simulation/Intensity masking','powermeter.csv'));
